...
const ServiceApproval = () => {
  ...
  const fetchServices = async () => {
    try {
      ...
      const res = await axios.get(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/admin/getservices`, {
  ...
  const handleApprove = async (id) => {
    try {
      const token = localStorage.getItem("adminToken");
      await axios.patch(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/admin/service/${id}/approve`, {}, {
        headers: { Authorization: `Bearer ${token}` },
      });
      setServices(prev =>
        prev.map(s =>
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = localStorage.getItem("adminToken");
      await axios.delete(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/admin/service/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
              ...
              <tr key={s._id} className="border-b hover:bg-purple-50">
                ...
                <td className="py-2 px-4 text-center space-x-2">
                  ...
                  <button
                    ...
                    className="text-purple-600 hover:underline font-medium text-xs ml-2"
                  >
                    Delete
                  </button>
                </td>
          ...
          >
            ...
            <div className="mb-3">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                className="w-full border px-3 py-2 rounded-md focus:outline-none focus:ring-purple-300"
                required
              />
            </div>
            ...
            <div className="mb-3">
              ...
              <label className="inline-block cursor-pointer bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-md font-medium transition mr-2">
                Choose File
                <input
                  type="file"
                  name="mainImage"
