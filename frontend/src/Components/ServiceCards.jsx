          ...
          >
            ...
            <div className="p-4 flex-1 flex flex-col justify-between">
              ...
              <div className="flex items-center gap-2 my-2">
                ...
                <p className="font-bold text-purple-600">₹{service.finalPrice}</p>
              ...
              <button
                className="mt-3 px-6 py-2 bg-white border border-purple-500 text-purple-500 rounded-lg font-bold hover:bg-purple-50 self-end"
                onClick={(e) => {
                  e.stopPropagation();
                  addToCart({
                    id: service._id,
        ...
        <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center">
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full mx-4 p-6 relative">
            ...
            <div className="mt-4 flex items-center gap-3">
              <p className="text-lg font-bold text-purple-600">₹{selectedService.finalPrice}</p>
            ...
            <div className="flex w-full gap-3 mt-6">
              <button
                className="flex-1 py-3 rounded-lg font-bold text-white bg-purple-500 hover:bg-purple-600 transition text-lg"
                onClick={() => {
                  addToCart({
